...
# csv header - required for the import - remember we are using CSV (not tabs)
my $csv_header = "Group/Title,Username,Password,URL,AutoType,Created Time,Password Modified Time,Last Access Time,Password Expiry Date,Record Modified Time,History,Notes";
...
print "Group/Title,Username,Password,URL,AutoType,Created Time,Password Modified Time,Last Access Time,Password Expiry Date,Record Modified Time,History,Notes\n";
print @psafe;
print "\n\n\n";
