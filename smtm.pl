...
#   $Id: smtm.pl,v 1.117 2005/05/16 03:21:51 edd Exp $
...
$VERSION = "1.6.6";		# updated from the debian/rules Makefile
my $date =			# inner expression updated by RCS
  sprintf("%s", q$Date: 2005/05/16 03:21:51 $ =~ /\w*: (\d*\/\d*\/\d*)/);
...
Copyright (C) 1999 - 2005 by Dirk Eddelbuettel <edd\@debian.org>
...
smtm is (c) 1999 - 2005 by Dirk Eddelbuettel <edd@debian.org>
